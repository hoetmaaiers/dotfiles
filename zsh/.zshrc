...
# Mimick GNU getopt, by default macOS comes with BSD version of getopt
export PATH="/Applications/QGIS-LTR.app/Contents/MacOS/bin:$PATH"
export PATH="/Applications/Postgres.app/Contents/Versions/latest/bin:/opt/homebrew/opt/gnu-getopt/bin:$PATH"
